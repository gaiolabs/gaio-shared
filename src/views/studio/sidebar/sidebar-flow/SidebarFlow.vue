<template>
	...
	>
		...
		<GCard class="flex grow flex-col overflow-hidden rounded-2xl py-2">
			<flow-control
				v-if="currentFlow"
				:flow="currentFlow"
...
import FlowControl from '@/views/studio/sidebar/sidebar-flow/FlowControl.vue'
import FlowControlScheduleBulk from '@/views/studio/sidebar/sidebar-flow/FlowControlScheduleBulk.vue'
