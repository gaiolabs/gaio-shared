...
import { useDebounceFn, useLocalStorage, useResizeObserver } from '@vueuse/core/index.cjs'
import * as monaco from 'monaco-editor'
import { onMounted, onUnmounted, ref, toRefs } from 'vue'
import { STORAGE_NAMES, type LANGUAGES, type PAYLOAD } from '../types/types'
...
<template>
	<div class="flex flex-col w-full h-full">
		<div class="font-semibold text-xl text-white pb-1 pl-1 border-gray-700 border-b-2">
