...
import TaskReportOptions from '@/views/studio/tasks/task-explorer/TaskExplorerOptions.vue'
import TaskReportPreview from '@/views/studio/tasks/task-explorer/TaskExplorerPreview.vue'
import TaskReportSchema from '@/views/studio/tasks/task-explorer/TaskExplorerSchema.vue'
import TaskReportSetup from '@/views/studio/tasks/task-explorer/TaskExplorerSetup.vue'
