...
import ColumnView from '@/views/studio/tasks/column-view/ColumnView.vue'
import { useColumnView } from '@/views/studio/tasks/column-view/useColumnView'
import TableColumns from '@/views/studio/tasks/table-view/TableColumns.vue'
import TableData from '@/views/studio/tasks/table-view/TableData.vue'
import TableFrequency from '@/views/studio/tasks/table-view/TableFrequency.vue'
import TableStats from '@/views/studio/tasks/table-view/TableStats.vue'
